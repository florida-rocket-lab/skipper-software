...
constexpr uint8_t IMU_FRAME_LEN = 25;
constexpr uint8_t IMU_PACKET_SIZE = IMU_FRAME_LEN + 2;
...
#define TEENSY_ESC1_PIN 8     // The original file by Jose says that this controls Servo 1; this is propeller 1 on the contra-rotating propeller
