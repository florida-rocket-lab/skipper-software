...
class skipperLQR final
{
 ...
 public:
  ...
  struct RT_MODEL_skipper_lqi_for_expo_T {
  ...
  skipperLQR::RT_MODEL_skipper_lqi_for_expo_T * getRTM();

  // Root inports set method
  void setExternalInputs(const ExtU_skipper_lqi_for_export_T
    *pExtU_skipper_lqi_for_export_T)
  {
    skipper_lqi_for_export_U = *pExtU_skipper_lqi_for_export_T;
  }

  // Root outports get method
  const ExtY_skipper_lqi_for_export_T &getExternalOutputs() const
  {
    return skipper_lqi_for_export_Y;
  }
...
extern const skipperLQR::ConstB_skipper_lqi_for_export_T
  skipper_lqi_for_export_ConstB;       // constant block i/o

// Constant parameters (default storage)
extern const skipperLQR::ConstP_skipper_lqi_for_export_T
  skipper_lqi_for_export_ConstP;
