...
void Nano::process_teensy_to_ground() {
    auto imu = teensy_pipe.receive<IMUData>();   // ← change type
    if (imu.get()) {                            // test with .get()
        Serial.print("Accel: ");
