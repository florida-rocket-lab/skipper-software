...
if __name__ == '__main__':
    ...
    system = [
        ...
        "-(T0*zeta0*cos(zeta0) - T*sin(zeta0) - T0*zeta*cos(zeta0) - M*p*w0 - M*p0*w + M*p0*w0 + M*r*u0 + M*r0*u - M*r0*u0 - M*p0^2*y + 2*M*p0^2*y0 - M*r0^2*y + 2*M*r0^2*y0 - 2*M*p*p0*y0 + M*p*q0*x0 + M*p0*q*x0 + M*p0*q0*x - 2*M*p0*q0*x0 + M*q*r0*z0 + M*q0*r*z0 + M*q0*r0*z - 2*M*q0*r0*z0 - 2*M*r*r0*y0 - M*g*cos(phi0)*sin(psi0) + M*g*psi0*cos(phi0)*cos(psi0) - M*g*psi*cos(phi0)*cos(psi0) + M*g*phi*sin(phi0)*sin(psi0) - M*g*phi0*sin(phi0)*sin(psi0) + M*g*cos(psi0)*sin(phi0)*sin(theta0) + M*g*phi*cos(phi0)*cos(psi0)*sin(theta0) - M*g*phi0*cos(phi0)*cos(psi0)*sin(theta0) + M*g*theta*cos(psi0)*cos(theta0)*sin(phi0) - M*g*theta0*cos(psi0)*cos(theta0)*sin(phi0) + M*g*psi0*sin(phi0)*sin(psi0)*sin(theta0) - M*g*psi*sin(phi0)*sin(psi0)*sin(theta0))/M",
        "-(T*cos(zeta0)*sin(xi0) + M*p*v0 + M*p0*v - M*p0*v0 - M*q*u0 - M*q0*u + M*q0*u0 - M*p0^2*z + 2*M*p0^2*z0 - M*q0^2*z + 2*M*q0^2*z0 - 2*M*p*p0*z0 + M*p*r0*x0 + M*p0*r*x0 + M*p0*r0*x - 2*M*p0*r0*x0 + T0*zeta0*sin(xi0)*sin(zeta0) - T0*zeta*sin(xi0)*sin(zeta0) - 2*M*q*q0*z0 + M*q*r0*y0 + M*q0*r*y0 + M*q0*r0*y - 2*M*q0*r0*y0 + M*g*sin(phi0)*sin(psi0) + T0*xi*cos(xi0)*cos(zeta0) - T0*xi0*cos(xi0)*cos(zeta0) + M*g*phi*cos(phi0)*sin(psi0) - M*g*phi0*cos(phi0)*sin(psi0) - M*g*psi0*cos(psi0)*sin(phi0) + M*g*psi*cos(psi0)*sin(phi0) + M*g*cos(phi0)*cos(psi0)*sin(theta0) + M*g*theta*cos(phi0)*cos(psi0)*cos(theta0) - M*g*theta0*cos(phi0)*cos(psi0)*cos(theta0) - M*g*phi*cos(psi0)*sin(phi0)*sin(theta0) + M*g*phi0*cos(psi0)*sin(phi0)*sin(theta0) + M*g*psi0*cos(phi0)*sin(psi0)*sin(theta0) - M*g*psi*cos(phi0)*sin(psi0)*sin(theta0))/M",
