...
% space Simulink model and LQR controller.
    ...
    A = [
        cos(psi0)*cos(theta0) sin(phi0)*sin(theta0)*cos(psi0)-sin(psi0)*cos(phi0) sin(phi0)*sin(psi0)+sin(theta0)*cos(phi0)*cos(psi0) v0*sin(phi0)*sin(psi0)+v0*sin(theta0)*cos(phi0)*cos(psi0)-w0*sin(phi0)*sin(theta0)*cos(psi0)+w0*sin(psi0)*cos(phi0) -u0*sin(theta0)*cos(psi0)+v0*sin(phi0)*cos(psi0)*cos(theta0)+w0*cos(phi0)*cos(psi0)*cos(theta0) -u0*sin(psi0)*cos(theta0)-v0*sin(phi0)*sin(psi0)*sin(theta0)-v0*cos(phi0)*cos(psi0)+w0*sin(phi0)*cos(psi0)-w0*sin(psi0)*sin(theta0)*cos(phi0) 0 0 0;
        sin(psi0)*cos(theta0) sin(phi0)*sin(psi0)*sin(theta0)+cos(phi0)*cos(psi0) -sin(phi0)*cos(psi0)+sin(psi0)*sin(theta0)*cos(phi0) -v0*sin(phi0)*cos(psi0)+v0*sin(psi0)*sin(theta0)*cos(phi0)-w0*sin(phi0)*sin(psi0)*sin(theta0)-w0*cos(phi0)*cos(psi0) -u0*sin(psi0)*sin(theta0)+v0*sin(phi0)*sin(psi0)*cos(theta0)+w0*sin(psi0)*cos(phi0)*cos(theta0) u0*cos(psi0)*cos(theta0)+v0*sin(phi0)*sin(theta0)*cos(psi0)-v0*sin(psi0)*cos(phi0)+w0*sin(phi0)*sin(psi0)+w0*sin(theta0)*cos(phi0)*cos(psi0) 0 0 0;
        -sin(theta0) sin(phi0)*cos(theta0) cos(phi0)*cos(theta0) v0*cos(phi0)*cos(theta0)-w0*sin(phi0)*cos(theta0) -u0*cos(theta0)-v0*sin(phi0)*sin(theta0)-w0*sin(theta0)*cos(phi0) 0 0 0 0;
        0 r0 -q0 0 g*sin(theta0)*cos(psi0) g*sin(psi0)*cos(theta0) 0 -w0 v0;
        -r0 0 p0 -g*sin(phi0)*sin(psi0)-g*sin(theta0)*cos(phi0)*cos(psi0) -g*sin(phi0)*cos(psi0)*cos(theta0) g*sin(phi0)*sin(psi0)*sin(theta0)+g*cos(phi0)*cos(psi0) w0 0 -u0;
        q0 -p0 0 g*sin(phi0)*sin(theta0)*cos(psi0)-g*sin(psi0)*cos(phi0) -g*cos(phi0)*cos(psi0)*cos(theta0) -g*sin(phi0)*cos(psi0)+g*sin(psi0)*sin(theta0)*cos(phi0) -v0 u0 0;
        0 0 0 q0*cos(phi0)*tan(theta0)-r0*sin(phi0)*tan(theta0) q0*sin(phi0)*tan(theta0)^2+q0*sin(phi0)+r0*cos(phi0)*tan(theta0)^2+r0*cos(phi0) 0 1 sin(phi0)*tan(theta0) cos(phi0)*tan(theta0);
        0 0 0 -q0*sin(phi0)-r0*cos(phi0) 0 0 0 cos(phi0) -sin(phi0);
        0 0 0 q0*cos(phi0)/cos(theta0)-r0*sin(phi0)/cos(theta0) q0*sin(phi0)*sin(theta0)/cos(theta0)^2+r0*sin(theta0)*cos(phi0)/cos(theta0)^2 0 0 sin(phi0)/cos(theta0) cos(phi0)/cos(theta0);
        0 0 0 0 0 0 0 Iyy*r0/Ixx-Izz*r0/Ixx Iyy*q0/Ixx-Izz*q0/Ixx;
        0 0 0 0 0 0 -Ixx*r0/Iyy+Izz*r0/Iyy 0 -Ixx*p0/Iyy+Izz*p0/Iyy;
        0 0 0 0 0 0 Ixx*q0/Izz-Iyy*q0/Izz Ixx*p0/Izz-Iyy*p0/Izz 0;
    ];
