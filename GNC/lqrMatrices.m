...
% space Simulink model and LQR controller.
    ...
    A = [
        0 r0 -q0 cos(psi0)*cos(theta0) sin(phi0)*sin(theta0)*cos(psi0)-sin(psi0)*cos(phi0) sin(phi0)*sin(psi0)+sin(theta0)*cos(phi0)*cos(psi0) v0*sin(phi0)*sin(psi0)+v0*sin(theta0)*cos(phi0)*cos(psi0)-w0*sin(phi0)*sin(theta0)*cos(psi0)+w0*sin(psi0)*cos(phi0) -u0*sin(theta0)*cos(psi0)+v0*sin(phi0)*cos(psi0)*cos(theta0)+w0*cos(phi0)*cos(psi0)*cos(theta0) -u0*sin(psi0)*cos(theta0)-v0*sin(phi0)*sin(psi0)*sin(theta0)-v0*cos(phi0)*cos(psi0)+w0*sin(phi0)*cos(psi0)-w0*sin(psi0)*sin(theta0)*cos(phi0) 0 -z0 y0;
        -r0 0 p0 sin(psi0)*cos(theta0) sin(phi0)*sin(psi0)*sin(theta0)+cos(phi0)*cos(psi0) -sin(phi0)*cos(psi0)+sin(psi0)*sin(theta0)*cos(phi0) -v0*sin(phi0)*cos(psi0)+v0*sin(psi0)*sin(theta0)*cos(phi0)-w0*sin(phi0)*sin(psi0)*sin(theta0)-w0*cos(phi0)*cos(psi0) -u0*sin(psi0)*sin(theta0)+v0*sin(phi0)*sin(psi0)*cos(theta0)+w0*sin(psi0)*cos(phi0)*cos(theta0) u0*cos(psi0)*cos(theta0)+v0*sin(phi0)*sin(theta0)*cos(psi0)-v0*sin(psi0)*cos(phi0)+w0*sin(phi0)*sin(psi0)+w0*sin(theta0)*cos(phi0)*cos(psi0) z0 0 -x0;
        q0 -p0 0 -sin(theta0) sin(phi0)*cos(theta0) cos(phi0)*cos(theta0) v0*cos(phi0)*cos(theta0)-w0*sin(phi0)*cos(theta0) -u0*cos(theta0)-v0*sin(phi0)*sin(theta0)-w0*sin(theta0)*cos(phi0) 0 -y0 x0 0;
        q0^2+r0^2 -p0*q0 -p0*r0 0 r0 -q0 0 g*sin(theta0)*cos(psi0) g*sin(psi0)*cos(theta0) -q0*y0-r0*z0 -p0*y0+2*q0*x0-w0 -p0*z0+2*r0*x0+v0;
        -p0*q0 p0^2+r0^2 -q0*r0 -r0 0 p0 -g*sin(phi0)*sin(psi0)-g*sin(theta0)*cos(phi0)*cos(psi0) -g*sin(phi0)*cos(psi0)*cos(theta0) g*sin(phi0)*sin(psi0)*sin(theta0)+g*cos(phi0)*cos(psi0) 2*p0*y0-q0*x0+w0 -p0*x0-r0*z0 -q0*z0+2*r0*y0-u0;
        -p0*r0 -q0*r0 p0^2+q0^2 q0 -p0 0 g*sin(phi0)*sin(theta0)*cos(psi0)-g*sin(psi0)*cos(phi0) -g*cos(phi0)*cos(psi0)*cos(theta0) -g*sin(phi0)*cos(psi0)+g*sin(psi0)*sin(theta0)*cos(phi0) 2*p0*z0-r0*x0-v0 2*q0*z0-r0*y0+u0 -p0*x0-q0*y0;
        0 0 0 0 0 0 q0*sin(theta0)*cos(phi0)/cos(theta0)-r0*sin(phi0)*sin(theta0)/cos(theta0) q0*sin(phi0)/cos(theta0)^2+r0*cos(phi0)/cos(theta0)^2 0 1 sin(phi0)*sin(theta0)/cos(theta0) sin(theta0)*cos(phi0)/cos(theta0);
    ...
    d = [
        -phi0*v0*sin(phi0)*sin(psi0) - phi0*v0*sin(theta0)*cos(phi0)*cos(psi0) + phi0*w0*sin(phi0)*sin(theta0)*cos(psi0) - phi0*w0*sin(psi0)*cos(phi0) + psi0*u0*sin(psi0)*cos(theta0) + psi0*v0*sin(phi0)*sin(psi0)*sin(theta0) + psi0*v0*cos(phi0)*cos(psi0) - psi0*w0*sin(phi0)*cos(psi0) + psi0*w0*sin(psi0)*sin(theta0)*cos(phi0) + q0*z0 - r0*y0 + theta0*u0*sin(theta0)*cos(psi0) - theta0*v0*sin(phi0)*cos(psi0)*cos(theta0) - theta0*w0*cos(phi0)*cos(psi0)*cos(theta0);
        -p0*z0 + phi0*v0*sin(phi0)*cos(psi0) - phi0*v0*sin(psi0)*sin(theta0)*cos(phi0) + phi0*w0*sin(phi0)*sin(psi0)*sin(theta0) + phi0*w0*cos(phi0)*cos(psi0) - psi0*u0*cos(psi0)*cos(theta0) - psi0*v0*sin(phi0)*sin(theta0)*cos(psi0) + psi0*v0*sin(psi0)*cos(phi0) - psi0*w0*sin(phi0)*sin(psi0) - psi0*w0*sin(theta0)*cos(phi0)*cos(psi0) + r0*x0 + theta0*u0*sin(psi0)*sin(theta0) - theta0*v0*sin(phi0)*sin(psi0)*cos(theta0) - theta0*w0*sin(psi0)*cos(phi0)*cos(theta0);
        p0*y0 - phi0*v0*cos(phi0)*cos(theta0) + phi0*w0*sin(phi0)*cos(theta0) - q0*x0 + theta0*u0*cos(theta0) + theta0*v0*sin(phi0)*sin(theta0) + theta0*w0*sin(theta0)*cos(phi0);
        -g*psi0*sin(psi0)*cos(theta0) - g*theta0*sin(theta0)*cos(psi0) - g*cos(psi0)*cos(theta0) + 2*p0*q0*y0 + 2*p0*r0*z0 - 2*q0^2*x0 + q0*w0 - 2*r0^2*x0 - r0*v0 + T0*xi0*sin(xi0)*cos(zeta0)/M + T0*zeta0*sin(zeta0)*cos(xi0)/M;
        g*phi0*sin(phi0)*sin(psi0) + g*phi0*sin(theta0)*cos(phi0)*cos(psi0) - g*psi0*sin(phi0)*sin(psi0)*sin(theta0) - g*psi0*cos(phi0)*cos(psi0) + g*theta0*sin(phi0)*cos(psi0)*cos(theta0) - g*sin(phi0)*sin(theta0)*cos(psi0) + g*sin(psi0)*cos(phi0) - 2*p0^2*y0 + 2*p0*q0*x0 - p0*w0 + 2*q0*r0*z0 - 2*r0^2*y0 + r0*u0 - T0*zeta0*cos(zeta0)/M;
        -g*phi0*sin(phi0)*sin(theta0)*cos(psi0) + g*phi0*sin(psi0)*cos(phi0) + g*psi0*sin(phi0)*cos(psi0) - g*psi0*sin(psi0)*sin(theta0)*cos(phi0) + g*theta0*cos(phi0)*cos(psi0)*cos(theta0) - g*sin(phi0)*sin(psi0) - g*sin(theta0)*cos(phi0)*cos(psi0) - 2*p0^2*z0 + 2*p0*r0*x0 + p0*v0 - 2*q0^2*z0 + 2*q0*r0*y0 - q0*u0 + T0*xi0*cos(xi0)*cos(zeta0)/M - T0*zeta0*sin(xi0)*sin(zeta0)/M;
        -phi0*q0*sin(theta0)*cos(phi0)/cos(theta0) + phi0*r0*sin(phi0)*sin(theta0)/cos(theta0) - q0*theta0*sin(phi0)/cos(theta0)^2 - r0*theta0*cos(phi0)/cos(theta0)^2;
